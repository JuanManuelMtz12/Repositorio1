...
public class RegistroUsuarios extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        correo = (EditText) view.findViewById(R.id.idEmail);
        telefono = (EditText) view.findViewById(R.id.idPhone);
        usuario = (EditText) view.findViewById(R.id.idUsuario);
        password = (EditText) view.findViewById(R.id.idPassword);

        registrar = (Button)view.findViewById(R.id.idRegistro);

        RequestQueue queue = Volley.newRequestQueue(getContext());

        Button registrar = view.findViewById(R.id.idLogin);
        Button cancelar = view.findViewById(R.id.idCancelar);
        ...
        registrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "http://192.168.137.247:80/proyectoMoviles/appmusic.php?nombre="+sNombre+"&apellidoPaterno="+sApellidoP+"&apellidoMaterno="+
                ...
                Navigation.findNavController(view).navigate(R.id.action_registroUsuarios_to_mainFragment);
            }
        });
